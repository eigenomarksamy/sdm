...
def run(args: argparse.Namespace) -> int:
    ...
    # Pre-flight. Without fpcalc every fingerprint comes back None, every pair
    # is dropped, and the run ends with "0 duplicate groups" — a clean bill of
    # health that means nothing. Catch it in seconds rather than hours.
